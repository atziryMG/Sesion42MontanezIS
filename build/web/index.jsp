<%-- 
    Document   : index
    Created on : 24 oct 2025, 07:35:53
    Author     : Atzy
--%>
...
<html>
    <head>
        <title>Pagina  Montañez Aplicacion WEB SOTWARE JSP - MYSQL 
...
<br>
        <div class="container">
            <center>
                ...
                <h4>LISTA OFICIAL DE USARIOS DE SISTEMA MONTAÑEZ</h4>
                <br>
            </center>  
                        ...
                        <div class="col-md-3 col-xs-6">
                            <div class="footer">
                                ...
                                <ul class="footer-links">
                                        ...
                                        <li><i class="fa fa-envelope-o"></i>Atziry Montanez</li>
                                </ul>
                            </div>
